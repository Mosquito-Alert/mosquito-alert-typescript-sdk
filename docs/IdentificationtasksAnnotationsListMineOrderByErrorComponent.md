...
```typescript
import { IdentificationtasksAnnotationsListMineOrderByErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksAnnotationsListMineOrderByErrorComponent = {
    attr,
    code,
    detail,
};
