...
```typescript
import { IdentificationtasksReviewCreateNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksReviewCreateNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
