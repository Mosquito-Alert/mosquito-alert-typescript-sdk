...
```typescript
import { IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
