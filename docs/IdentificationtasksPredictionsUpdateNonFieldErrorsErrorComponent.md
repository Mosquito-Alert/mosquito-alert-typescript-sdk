...
```typescript
import { IdentificationtasksPredictionsUpdateNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksPredictionsUpdateNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
