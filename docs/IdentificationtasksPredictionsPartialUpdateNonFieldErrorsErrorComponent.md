...
```typescript
import { IdentificationtasksPredictionsPartialUpdateNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksPredictionsPartialUpdateNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
