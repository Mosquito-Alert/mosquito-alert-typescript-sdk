...
```typescript
import { IdentificationtasksAnnotationsListCreatedAtErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksAnnotationsListCreatedAtErrorComponent = {
    attr,
    code,
    detail,
};
