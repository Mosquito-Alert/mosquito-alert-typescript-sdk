...
```typescript
import { IdentificationtasksAnnotationsListMineCreatedAtErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksAnnotationsListMineCreatedAtErrorComponent = {
    attr,
    code,
    detail,
};
