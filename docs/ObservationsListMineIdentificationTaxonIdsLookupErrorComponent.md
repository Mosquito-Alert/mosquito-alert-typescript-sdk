...
```typescript
import { ObservationsListMineIdentificationTaxonIdsLookupErrorComponent } from 'mosquito-alert';

const instance: ObservationsListMineIdentificationTaxonIdsLookupErrorComponent = {
    attr,
    code,
    detail,
};
