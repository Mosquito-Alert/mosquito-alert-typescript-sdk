...
```typescript
import { ObservationsGeoListIdentificationTaxonIdsLookupErrorComponent } from 'mosquito-alert';

const instance: ObservationsGeoListIdentificationTaxonIdsLookupErrorComponent = {
    attr,
    code,
    detail,
};
