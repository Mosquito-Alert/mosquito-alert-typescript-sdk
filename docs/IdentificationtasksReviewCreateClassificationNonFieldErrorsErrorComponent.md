...
```typescript
import { IdentificationtasksReviewCreateClassificationNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksReviewCreateClassificationNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
