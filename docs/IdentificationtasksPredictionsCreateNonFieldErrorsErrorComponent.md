...
```typescript
import { IdentificationtasksPredictionsCreateNonFieldErrorsErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksPredictionsCreateNonFieldErrorsErrorComponent = {
    attr,
    code,
    detail,
};
