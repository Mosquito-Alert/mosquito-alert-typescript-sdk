...
```typescript
import { ObservationsListIdentificationTaxonIdsLookupErrorComponent } from 'mosquito-alert';

const instance: ObservationsListIdentificationTaxonIdsLookupErrorComponent = {
    attr,
    code,
    detail,
};
