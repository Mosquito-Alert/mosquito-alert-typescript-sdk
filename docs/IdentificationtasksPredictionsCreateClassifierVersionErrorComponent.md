...
```typescript
import { IdentificationtasksPredictionsCreateClassifierVersionErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksPredictionsCreateClassifierVersionErrorComponent = {
    attr,
    code,
    detail,
};
