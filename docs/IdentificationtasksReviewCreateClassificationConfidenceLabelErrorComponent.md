...
```typescript
import { IdentificationtasksReviewCreateClassificationConfidenceLabelErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksReviewCreateClassificationConfidenceLabelErrorComponent = {
    attr,
    code,
    detail,
};
