...
```typescript
import { IdentificationtasksAnnotationsListOrderByErrorComponent } from 'mosquito-alert';

const instance: IdentificationtasksAnnotationsListOrderByErrorComponent = {
    attr,
    code,
    detail,
};
