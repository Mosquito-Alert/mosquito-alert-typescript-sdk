 ...
 * 
 * @export
 * @interface IdentificationtasksListMineOrderByErrorComponent
 */
export interface IdentificationtasksListMineOrderByErrorComponent {
    /**
     * 
     * @type {BitesListMineOrderByErrorComponentAttr}
     * @memberof IdentificationtasksListMineOrderByErrorComponent
     */
