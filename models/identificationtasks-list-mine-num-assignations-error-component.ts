 ...
 * 
 * @export
 * @interface IdentificationtasksListMineNumAssignationsErrorComponent
 */
export interface IdentificationtasksListMineNumAssignationsErrorComponent {
    /**
     * 
     * @type {IdentificationtasksListMineNumAssignationsErrorComponentAttr}
     * @memberof IdentificationtasksListMineNumAssignationsErrorComponent
     */
