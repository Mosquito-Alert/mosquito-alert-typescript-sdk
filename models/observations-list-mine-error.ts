...
// May contain unused imports in some cases
// @ts-ignore
import type { ObservationsListMineWithinGeomErrorComponent } from './observations-list-mine-within-geom-error-component';

/**
 * @type ObservationsListMineError
 */
export type ObservationsListMineError = { attr: 'country_id' } & ObservationsListMineCountryIdErrorComponent | { attr: 'created_at' } & ObservationsListMineCreatedAtErrorComponent | { attr: 'geo_precision' } & ObservationsListMineGeoPrecisionErrorComponent | { attr: 'identification_taxon_ids' } & ObservationsListMineIdentificationTaxonIdsErrorComponent | { attr: 'identification_taxon_ids_lookup' } & ObservationsListMineIdentificationTaxonIdsLookupErrorComponent | { attr: 'order_by' } & ObservationsListMineOrderByErrorComponent | { attr: 'received_at' } & ObservationsListMineReceivedAtErrorComponent | { attr: 'short_id' } & ObservationsListMineShortIdErrorComponent | { attr: 'tags' } & ObservationsListMineTagsErrorComponent | { attr: 'updated_at' } & ObservationsListMineUpdatedAtErrorComponent | { attr: 'user_uuid' } & ObservationsListMineUserUuidErrorComponent | { attr: 'within_geom' } & ObservationsListMineWithinGeomErrorComponent;
