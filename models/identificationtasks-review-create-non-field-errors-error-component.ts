 ...
 * 
 * @export
 * @interface IdentificationtasksReviewCreateNonFieldErrorsErrorComponent
 */
export interface IdentificationtasksReviewCreateNonFieldErrorsErrorComponent {
    /**
     * 
     * @type {AuthChangePasswordNonFieldErrorsErrorComponentAttr}
     * @memberof IdentificationtasksReviewCreateNonFieldErrorsErrorComponent
     */
